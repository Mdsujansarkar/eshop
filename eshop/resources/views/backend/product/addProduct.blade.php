        ...
        <div class="container-fluid">
            ...
            {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input id="product_quantity" name="product_quantity" placeholder="Product Quantity" class="form-control input-md" required="" type="number">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <textarea id="product_short_description" name="product_short_desc" placeholder="Product Short Description" class="form-control input-md" required=""></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="product_long_description">Product Long Description </label>
                        <div class="col-md-4">
                            <textarea id="product_long_description" name="product_long_desc" placeholder="Product Long Description" class="form-control input-md" required="" ></textarea>
                        </div>
                    </div>
                    <div class="form-group">
